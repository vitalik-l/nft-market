...
const Description = tw.p`mt-4 text-gray-900 text-center md:text-left text-base md:text-base lg:text-lg font-medium leading-relaxed whitespace-break-spaces`;
