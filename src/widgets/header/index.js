...
const Root = tw.header`
  flex justify-between items-center
  max-w-screen-xl mx-auto
`;

export const NavLinks = tw.div`inline-flex items-center gap-[2rem]`;
      ...
      >
        <Select.Option value="en">
          <div css={tw`flex items-center gap-2`}>
            <img src="https://media.flaticon.com/dist/min/img/flags/en.svg" css={tw`w-[1em] h-[1em]`} />
            En
          </div>
        </Select.Option>
        <Select.Option value="fr">
          <div css={tw`flex items-center gap-2`}>
            <img src="https://media.flaticon.com/dist/min/img/flags/fr.svg" css={tw`w-[1em] h-[1em]`} />
            Fr
          </div>
        </Select.Option>
        <Select.Option value="es">
          <div css={tw`flex items-center gap-2`}>
            <img src="https://media.flaticon.com/dist/min/img/flags/es.svg" css={tw`w-[1em] h-[1em]`} />
            Es
          </div>
        </Select.Option>
      </Select>
